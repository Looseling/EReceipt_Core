...
namespace EReceipt.Core
{
    public static class Program
    {
        ...
        {
            License.LicenseKey = "IRONSUITE.RAYWOM92.GMAIL.COM.18739-1E5C08494A-BIPE3TQ-7ANFCPLFVNHK-3RSQ3K22TNHI-6EF737M7X6VD-QBO7EZJ2OYCB-EZKSKMBHKJTB-IT2TFFQKB63A-DOEVO3-TXRMWYIHBFWLEA-DEPLOYMENT.TRIAL-LCX3W3.TRIAL.EXPIRES.20.NOV.2023";
...
// Loop through the Items dictionary and append a table row for each item
                  foreach (var item in result.Items)
                  {
                    ...
                    sb.Append($"<td align=\"left\" width=\"25%\" style=\"padding: 6px 12px;font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px;\">{item.Value} zl</td>");
                    sb.Append("</tr>");
                  }
...
<body style=""background-color: #D2C7BA;"">
  ...
  <!-- end body -->
            ...
            app.MapGet("/Transactions", () => MockData.OldTransactions);
